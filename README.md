...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/planetary-computer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12632&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/planetary-computer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `planetary-computer` can be installed with:

```
conda install planetary-computer
```

It is possible to list all of the versions of `planetary-computer` available on your platform with:
